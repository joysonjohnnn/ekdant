              ...
              <div className="service__list-3" ref={serviceList}>
                <div className="service__item-3 service_animation">
                  ...
                  <div className="service__content-3">
                    <p>
                      We help you to build your native application which would help reorganize the cross platform application to reality
                    </p>
                    <ul className="">
                      <li>+ Android App</li>
                      <li>+ iOS App</li>
                  ...
                  <div
                    ...
                    style={{
                      backgroundImage: "url(assets/imgs/service/3/11.png)",
                    }}
                  ></div>
                </div>
                ...
                <div className="service__item-3 service_animation">
                  ...
                  <div className="service__content-3">
                    <p>
                      We help brands stand out through stunning, elegant visual
                      design with best UI/UX .
                    </p>
                    <ul className="">
                      <li>+ PHP</li>
                      <li>+ WordPress</li>
                  ...
                  <div
                    className="service__hover-3"
                    style={{
                      backgroundImage: "url(assets/imgs/service/3/22.png)",
                    }}
                  ></div>
                </div>
                ...
                <div className="service__item-3 service_animation">
                  ...
                  <div className="service__content-3">
                    <p>
                      We have world class experts on SEO and SEM to make your website ranking go top 
                    </p>
                    <ul className="">
                      <li>+ SEO</li>
                      <li>+ SEM</li>
