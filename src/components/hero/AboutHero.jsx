              ...
              <div className="hero__about-content">
                ...
                <div className="hero__about-info">
                  ...
                  <div className="hero__about-text title-anim">
                    <p>
                      {
                        "Think of the world's most iconica and successful brands easily findable, impactful. Interactional and exceptional designs. Our story takes beginning in 2023"
                      }
                    </p>
                  </div>
